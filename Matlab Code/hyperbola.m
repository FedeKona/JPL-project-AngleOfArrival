...
% Restore original
cleanupRestore = onCleanup(@() set(groot, ...
    'defaultLineLineWidth', oldDefaults.defaultLineLineWidth, ...
    'defaultFigureColor',    oldDefaults.defaultFigureColor, ...
    'defaultAxesFontSize',   oldDefaults.defaultAxesFontSize, ...
    'defaulttextinterpreter',oldDefaults.defaultTextInterpreter, ...
    'defaultAxesTickLabelInterpreter', oldDefaults.defaultAxesTickLabelInterpreter, ...
    'defaultLegendInterpreter', oldDefaults.defaultLegendInterpreter));
...
addpath(genpath('/Users/fmarsan/Documents/MATLAB/matlab2tikz'));
figurewidth = '10cm';
figureheight = '7cm';
%matlab2tikz('hperbolas2.tex','height',figureheight,'width',figurewidth,'strict',true);
